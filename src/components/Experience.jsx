import { Cpu, Layers, Layout, Terminal,Briefcase,Building, Calendar } from 'lucide-react'
    ...
    const experiences = [
        {
            id: 1,
            role: 'Media & Outreach',
            company: 'ACES,Purwanchal Campus',
            ...
            <div className='flex items-center justify-between mb-2'>
                ...
                <div data-aos='fade-left'>
                    ...
                    <div className='space-y-6'>
                        {experiences.map((exp) => (
                            <div key={exp.id} className='group relative p-6 rounded-2xl bg-[#1f1641] border hover:border-primary/50 transition-all duration-300'>
